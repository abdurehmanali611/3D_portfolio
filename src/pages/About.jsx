...
const About = () => {
  return (
    <section className='max-container'>
      ...
      <span className='blue-gradient-text font-semibold drop-shadow'> Abdurehman</span>
      </h1>

      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          software engineer based in addis ababa, specializing in 
      ...
      <div className='py-16'>
          ...
          <div className='mt-5 flex flex-col gap-3 text-slate-500'>
            <p>
                ...
                leveling up my skills teaming up with samrt people. 
                Here is the rundown 
            </p>
          </div>
